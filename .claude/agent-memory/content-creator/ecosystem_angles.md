---
name: ecosystem_angles
description: Per-project angle tracking — what has been covered and what remains open for each MY3YE ecosystem project
type: project
---
...
**Covered:**
- "You Cannot Build a New World with Broken People" — draft in DB (b6b478a5)
...
- Otto Music — "What the Algorithm Cannot Hear" (edcf8095, 2026-03-25): four fronts structure (Manager/Player/Studio/Events) + discovery algorithm problem + listener early-believer model. ALSO: existing article 8d15bb5a covers label extraction + royalties + AI tools. Open: events/festivals deep dive, artist residency story, cross-ecosystem audio integration.
...
**How to apply:** Before drafting any new piece, check this file. If the project already has a technical angle covered, go emotional/narrative. If emotional is covered, go technical. If both, find a specific sub-angle.
