...
- **Status**: draft (~4,900 words, v2.1 — review feedback applied 2026-04-12)
- **Story beat**: The Law + The Mission
- **v2.1 changes (2026-04-12)**: 10 reviewer edits applied. Critical: (1) κ percentage math replaced with bounded language (no unsubstantiated 23%/33% claims); (2) lathe example reclassified as "tools class, 5yr" — math verified correct; (3) Ec_physical=0.0 force majeure clause added for incapacitation/displacement. Warnings: (4) max_beneficiaries defined in Dv_physical formula (ProjectRegistry); (5) Compound attribution restored to 2023/Proposal289/$24M/Humpy; (6) Phase 0 Snapshot tracking parenthetical restored; (7) MAPA Sybil-resistance constraint sentence added. Suggestions: (8) Ec_digital reference to Technical Spec added; (9) "structurally impossible via contract enforcement" sharpened; (10) P_gov>0 single-contribution floor clarified.
- **What NOT to repeat**: Force majeure via Community Layer proposal as Ec_physical protection mechanism. "Capital captures less than a quarter" as bounded language without unsubstantiated percentages. MAPA Sybil-resistance = verified-contributors-only attesters.
