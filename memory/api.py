...
# Must run BEFORE lifespan (adding middleware after startup is forbidden).
from .telemetry import setup_telemetry, shutdown_telemetry
from .config import settings as _otel_settings
_otel_ok = setup_telemetry(app, _otel_settings)
if _otel_ok:
